...
## Adjusted settings and routes ##
In package.json, the lines
...
in order for it to work on windows machine

## Routes ##
'/reader' is the main home page, it shows the list of published articles for readers
'/reader/id' where id is a number based on the published article, it redirects to the article in question for reading
'/author' is the main home page for the author, this is where they keep track of drafts and published articles
'/author/new' is where the author creates a new draft
'/author/edit/id' is where the author can make changes to exisitng articles. id is the associated article id
'/author/settings' is where the author can change the Blog title, subtitle as well as the author name
